...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2022 at 08:50 AM
...
INSERT INTO `tb_hewan` (`id`, `nama`, `jenis`, `keluhan`, `username`, `password`) VALUES
(9, 'nur duwi', 'kucing', 'mulesss', '', ''),
(12, 'ida', 'kucing', 'panas', '', '');
